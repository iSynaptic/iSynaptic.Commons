...
namespace iSynaptic.Commons.Data
{
    ...
    public class MetadataResolverTests
    {
        ...
        {
            var binding = new MetadataBinding<int>(StringMetadata.MaxLength, 42);
        ...
        public void Resolve_WithScopeFactoryObject_CachesResult()
        {
            ...
            var binding = new MetadataBinding<int>(r => r.Declaration == StringMetadata.MaxLength, x => { resolveCount++; return 42; }, x => scopeObject);
